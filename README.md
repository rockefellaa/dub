...
mylx.co is the open-source link management infrastructure for modern marketing teams.

## Features

- [Advanced Analytics](https://mylx.co/features/analytics)
- [Branded Links](https://mylx.co/features/branded-links)
- [QR Codes](https://mylx.co/features/qr-codes)
- [Personalization](https://mylx.co/features/personalization)
- [Team Collaboration](https://mylx.co/features/collaboration)
...
You can self-host mylx.co for greater control over your data and design. [Read this guide](https://mylx.co/docs/self-hosting/guide) to learn more.
...
- Follow the [local development guide](https://mylx.co/docs/local-development) to get your local dev environment set up.
...
![mylx.co repo activity – generated by Axiom](https://repobeats.axiom.co/api/embed/6ac4c94a89ea20e2e10032b932a128b6d8442e66.svg "Repobeats analytics image")
