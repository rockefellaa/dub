...
export const parse = (req: NextRequest) => {
  ...
  // path is the path of the URL (e.g. mylx.co/stats/github -> /stats/github)
  ...
  const key = decodeURIComponent(path.split("/")[1]); // key is the first part of the path (e.g. mylx.co/stats/github -> stats)
