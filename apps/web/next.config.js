  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: "https://app.mylx.co/:path*",
        permanent: true,
        statusCode: 301,
      },
        ...
        (segment) => (
          {
            ...
            destination: `https://mylx.co/${segment}`,
            permanent: true,
            statusCode: 301,
          },
          {
            ...
            destination: `https://mylx.co/${segment}/:path*`,
            permanent: true,
            statusCode: 301,
          }
        ),
      ),
      {
        ...
        destination: "https://mylx.co/tools/metatags",
        permanent: true,
        statusCode: 301,
      },
      {
      ...
      },
      {
        ...
        destination: "https://preview.mylx.co",
        permanent: true,
        statusCode: 301,
      },
      {
        ...
        destination: "https://admin.mylx.co",
        permanent: true,
        statusCode: 301,
      },
    ];
